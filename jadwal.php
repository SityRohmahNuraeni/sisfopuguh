  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-2">
        <h3><i class="fas fa-calendar-alt mr-2"></i> JADWAL PELAJARAN</h3><hr>

        <a href="" class="btn btn-primary mb-3"><i class="fas fa-plus-square mr-2"></i>TAMBAH DATA JADWAL PELAJARAN</a>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form>
                    ...
                    <label for="nis">NIDN</label>
                    <input type="text" class="form-control" id="exampleFromControlInput1" placeholder="masukan nomor NIDN guru">
