  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-info fixed-top">
      <a class="navbar-brand" href="#">SISFO | <b>SMK PUGUH</b></a>
        ...
        <div class="icon">
          <h5>
            <i class="fas fa-envelope mr-3 ml-3" data-toogle="tooltip" title="Surat Masuk"></i>
    ...
    <div class="row no-gutters mt-5">
      <div class="col-md-2 bg-dark  mt-2 pr-3 pt-4">
        ...
        if(isset($_POST["submit"])) {
         ...
         <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambah_data"><i class="fas fa-plus-square mr-2"></i>TAMBAH DATA SISWA</button>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form>
                    ...
                    <input type="text" name="nis" class="form-control" id="nis" placeholder="masukan nomor nis siswa">

                    <label for="tempat_tgl_lahir">TEMPAT TGL LAHIR</label>
                    <input type="text" name="tempat_tgl_lahir" class="form-control" id="tempat_tgl_lahir" placeholder="masukan tempat tgl lahir siswa">

                    <label for="alamat">ALAMAT</label>
                    <input type="text" name="alamat" class="form-control" id="alamat" placeholder="masukan alamat siswa">
                  </form>
              </div>
        ...
        <table class="table table-striped table-bordered text-center">
          ...
          <?php foreach ($siswa as $swa) : ?>
            ...
            <tr>
              ...
              <td><a href="ubah.php?id=<?= $swa["id"]; ?> "onclick= "return confirm('apakah anda yakin ingin mengedit')"><i class="fas fa-edit" data-toggle="tooltip" title="Edit" style="color: #266de8;"></i></a></td>
              <td><a href="hapus.php?id=<?= $swa["id"]; ?> "onclick= "return confirm('apakah anda yakin ingin menghapus')"><i class="fas fa-trash-alt" data-toggle="tooltip" title="Edit" style="color: #266de8;"></i></a></td>
            </tr>
            <?php $i++; ?>
          <?php endforeach ?>
        </table>
